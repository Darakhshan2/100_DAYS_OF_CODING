...
let dinnerGuest:string[]=['Subhan', 'Ali', 'Ilsa', 'Darak', 'Mustufa', 'Malaika'];
console.log("\n",dinnerGuest);
...
while(dinnerGuest.length > 2){
    let remove = dinnerGuest.pop()
    console.log(`\n Sorry ${remove}, I can't invite you to dinner.`);
}

dinnerGuest.forEach(dinnerGuest=>{
    console.log(`\nCongratulations, ${dinnerGuest} you are still invited`);
})
